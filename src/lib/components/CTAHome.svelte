    ...
    >
      <div class="max-w-xl lg:max-w-lg">
        <h2 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
          Caravan su misura! <span class="text-secondary">Soluzioni per ogni esigenza</span>
        </h2>
        <p class="mt-4 text-lg leading-8 text-gray-600">
          Progettiamo e costruiamo caravan nuovi e personalizzati, rispondendo a qualsiasi
          richiesta: dalla realizzazione di veicoli unici, alle automazioni e sistemi di controllo
          remoto. Offriamo anche revisioni, manutenzioni e riparazioni su ogni tipo di camper e
          caravan.<br />
          Affidati a noi per innovazione, qualità e assistenza completa.
        </p>
