  ...
  <div class="relative container mx-auto px-4 py-16">
    <div class="grid grid-cols-1 gap-12 md:grid-cols-3">
      ...
      <div class="flex flex-col items-center space-y-4 text-center md:items-start md:text-left">
        <div class="-ml-5 overflow-hidden rounded-xl py-3 backdrop-blur-sm">
      ...
      <!-- Contact Info -->
      <div class="space-y-4">
        <h3 class="text-2xl font-bold text-black drop-shadow-md">Info e contatti</h3>
        <div class="space-y-3 text-black/90">
          <p class="font-semibold text-black">OFFICINE MECCANICHE GIACOMELLA</p>
          <div class="space-y-2">
            ...
            <p class="flex items-center gap-2">
              ...
              >
                ...
                /></svg
              >
              <a href="tel:+390461765169" class="transition-colors hover:text-black/60"
                >0461 765169</a
              >
            </p>
            <p class="flex items-center gap-2">
              ...
              <a
                ...
                class="transition-colors hover:text-black/60"
              >
      ...
      <!-- Links & Rimorchi Section -->
      <div class="space-y-6">
        <div class="space-y-4">
          <h4 class="text-xl font-bold text-black drop-shadow-md">Sezione Rimorchi</h4>
          <a
